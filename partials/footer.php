    ...
    <script src="/assets/js/vendor/inputmask/jquery.inputmask.js"></script>
    <script src="/assets/js/vendor/typeahead/typeahead.jquery.min.js"></script>
    ...
    <script>
    	...
    	$(document).ready(function(){
    		...
    		$('input[name=credit_card_number]')
    			...
    			.on('keydown',function(e){
    				var icon 	= $('.col-credit-card .credit-card-icon');
    				var value 	= $(this).val();
    				var type	= $.payment.cardType(value);
    				console.log(type);
    				switch(type){
    					case "visa":
							icon.attr('src','/assets/img/icons/visa.png');
							break;
							
						case "discover":
							icon.attr('src','/assets/img/icons/discover.png');
							break;
							
						case "amex":
							icon.attr('src','/assets/img/icons/amex.png');
							break;
							
						case "mastercard":
							icon.attr('src','/assets/img/icons/mastercard.png');
							break;
					}
    			});
    		$('input[name=credit_card_ccv]').inputmask('999');
		...
		$('.form-group-state .typeahead').typeahead({
		  hint: true,
		  highlight: true,
		  minLength: 1
		},
